...
//  Netflix Clone
//
//  Created by Amalnath N D on 17/11/22.
//
...
class HomeViewController: UIViewController {
    ...
    let sectionTitles:[String] = ["trending Movie","trending Tv","popular","upcoming Movie","Top rated"
    ]
    ...
    private func configureHeroHeaderView(){
        ...
        navigationItem.rightBarButtonItems = [
            UIBarButtonItem(image: UIImage(systemName: "person"), style: .done, target: self, action:#selector(profileClick)),
